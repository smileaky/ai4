...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("GDRIVE_FILE_ID", "1UFNUWBtapP05lWir8GTJc7Gpe8u_u6Y5")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
     ...
     labels[2]: {
       ...
       "videos": ["https://www.youtube.com/watch?v=sw2YbfPbHk0"]
     },
    labels[3]: {
       ...
       "videos": ["https://www.youtube.com/watch?v=I2qFM6dg_xU"]
     }
}
